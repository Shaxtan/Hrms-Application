...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Scaffold(
        ...
        appBar: SharedAppBar(title: 'My Profile'),
        body: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            _tile(
              ...
              t.isDark ? 'Currently using dark theme' : 'Currently using light theme',
              () => ThemeController.to.toggle(),
            ),
            _tile(t, Icons.help_outline_rounded, 'Help & Support', 'FAQs, contact us', () {}),
  ...
  Widget _tile(ThemeController t, IconData icon, String title,
          ...
          child: Column(children: [
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(width: 68, height: 68,
                  ...
                  child: Center(child: Text(auth.userInitials.value,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: Colors.white.withOpacity(0.15))),
              child: Row(children: [
                const Icon(Icons.badge_rounded, color: Colors.white54, size: 16),
